...
CFLAGS		= -Os -Wpointer-arith -Wundef -Wno-error -Wl,-EL -fno-inline-functions -nostdlib -mlongcalls -mtext-section-literals  -D__ets__ -DICACHE_FLASH
...
$(TARGET_OUT): $(APP_AR)
	$(vecho) "LD $@"
	$(Q) $(LD) -L$(SDK_LIBDIR) $(LD_SCRIPT) $(LDFLAGS) -Wl,--start-group -lsmartconfig $(LIBS) $(APP_AR) -Wl,--end-group -o $@
